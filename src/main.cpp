...
int main(int argc, char * argv[])
{
	...
	cout << "WARNING: Make sure to connect your Duckstation emulator via Netplay with your opponent in the FM PvP screen before running this program. Doing otherwise may desynchronize the deck shuffle.\n" << endl;
	...
	if (!InitOnline())
	{
		cout << "\nCouldn't find the emulator window. Make sure that your emulator is open and the a YGOFM ROM is loaded." << endl;
		return 0;
	}
	
	cout << "\nFM Online connected to Duckstation successfully." << endl;
